...
dataDir = 'C:\Users\Administrator\Google Drive\Grad School\Master''s\CanonVideos\20140514Hand\cuts';

list=dir ([dataDir '\*.mp4']);

resultsDir='C:\Users\Administrator\Google Drive\Grad School\Master''s\VMx\output\hand\stab';
%%%%%
%for 64x64
%width=61;
%height=61;
...
stabilize_region_ainVM(vidFile, lu, rd, outName);
width=29;
height=29;
x0=x1-width;
y0=y1-height;
